...
- избранное, история цен, город пользователя;
...
Если стоимость доставки не передана, бот явно пишет «не указана источником». Такое предложение показывается после вариантов с известной итоговой ценой и не используется для PriceAlert, чтобы не выдавать цену товара за полную стоимость покупки.
